...
- **Message Loop Prevention:** Ignores messages for a configurable amount of time after the bot itself has sent a message, preventing potential infinite loops.
...
- `wait_after_message_from_self`: Time in seconds to ignore messages after the bot has sent a message (default: 30 seconds).
